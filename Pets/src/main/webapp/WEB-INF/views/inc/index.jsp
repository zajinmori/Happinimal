                ...
                <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="/pet/resources/img/dog and volunteer.jpg" class="img-fluid w-100" alt="Image">
                        ...
                        <div class="carousel-item">
                            <img src="/pet/resources/img/rescue.jpg" class="img-fluid w-100" alt="Image">
                ...
                <div class="row g-4">
                    <div class=" col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-4">
                            <div class="feature-icon mb-3"><img src="/pet/resources/img/chatting.png"></img></div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="feature-item p-4">
                            <div class="feature-icon mb-3"><img src="/pet/resources/img/petfoot.png"></img></div>
                            <a href="/pet/quiz.do" class="h4 mb-3">나랑 맞는 반려동물은 ?</a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="feature-item p-4">
                            <div class="feature-icon mb-3"><img src="/pet/resources/img/videocam.png"></img></div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="feature-item p-4">
                            <div class="feature-icon mb-3"><img src="/pet/resources/img/giveheart.png"></img></div>
