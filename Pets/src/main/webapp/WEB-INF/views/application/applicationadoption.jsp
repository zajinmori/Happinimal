...
<html lang="en">
    ...
    <!-- <form id="applicationform" action="/applicationadoption/submit" method="post"> -->
    <form action="${pageContext.request.contextPath}/submit" method="post">
        ...
        <input class="userans" type="tel" id="tel" name="telephone" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" placeholder="예: 010-1234-5678" required> 
        <br><br>
        ...
        <select class="userans" id="preferredCallTime" name="calltime" required>
        ...
        <select class="userans" id="area" name="region" required>
        ...
        <input class="userans" type="radio" name="maritalStatus" value="1"> 결혼함&nbsp;
        <input class="userans" type="radio" name="maritalStatus" value="0"> 결혼하지 않음<br><br>
        ...
        <input class="userans" type="radio" name="q1" value="1"> 있음&nbsp;
        <input class="userans" type="radio" name="q1" value="0"> 없음<br><br>

        <label class="adoptionquestion" for="q1Memo">과거 반려동물 경험 서술</label>
        <textarea class="userans" id="petExperienceDetails" name="q1Memo"></textarea><br><br>

        <label class="adoptionquestion" for="q2">현재 반려동물 여부</label>
        <input class="userans" type="radio" name="q2" value="1"> 있음&nbsp;
        <input class="userans" type="radio" name="q2" value="0"> 없음<br><br>
        
        <label class="adoptionquestion" for="q3Adult">가족 인원 수(성인)</label>
        <input class="userans" type="number" id="familyadult" name="q3Adult" required min="1" max="20"> 명<br><br>
        <label class="adoptionquestion" for="q3Minor">가족 인원 수(미성년자)</label>
        <input class="userans" type="number" id="familykid" name="q3Minor" required min="0" max="20"> 명<br><br>
        
        <label class="adoptionquestion" for="q4">현재 살고있는 주택의 형태는 무엇입니까?</label>
        <input class="userans" type="radio" name="q4" value="1"> 아파트&nbsp;&nbsp;
        <input class="userans" type="radio" name="q4" value="2"> 단독주택&nbsp;&nbsp;
        <input class="userans" type="radio" name="q4" value="3"> 빌라/다세대&nbsp;&nbsp;
        <input class="userans" type="radio" name="q4" value="4"> 원룸 <br><br>
        
        
        <label class="adoptionquestion" for="q5">입양에 대한 가족들의 입장</label>
        <input class="userans" type="radio" name="q5" value="0"> 본인제외 모두반대&nbsp;&nbsp;
        <input class="userans" type="radio" name="q5" value="1"> 부분 찬성&nbsp;&nbsp;
        <input class="userans" type="radio" name="q5" value="2"> 모두 찬성 <br><br>

        <label class="adoptionquestion" for="q6Memo">입양을 원하는 이유</label>
        <textarea class="userans" id="reasonadoption" name="q6Memo"></textarea><br><br>

        <label class="adoptionquestion" for="q7">만약 댁에서 새로운 아기가 출생할 경우 입양된 동물을 계속 키우실 수 있겠습니까?</label>
        <input class="userans" type="radio" name="q7" value="1"> 예&nbsp;
        <input class="userans" type="radio" name="q7" value="0"> 아니오<br><br>
        

        <label class="adoptionquestion" for="q8">귀하와 가족의 부재시(여행,명절,휴가 등) 반려동물을 어떻게 관리하실 예정이신가요?</label>
        <textarea class="userans" id="absence" name="q8"></textarea><br><br>


        <label class="adoptionquestion" for="q9">반려동물 중성화수술에 대한 의견을 남겨주세요</label>
        <textarea class="userans" id="neutering" name="q9"></textarea><br><br>

        
        <label class="adoptionquestion" for="q10">저희가 귀하의 가정을 사전약속 하에 방문하는 것에 대해서는 어떻게 생각하시나요?</label>
        <textarea class="userans" id="visit" name="q10"></textarea><br><br>
		
		
		<label class="adoptionquestion" for="q11">반려동물을 10년 이상 키우실 수 있습니까?</label>
        <input class="userans" type="radio" name="q11" value="1"> 예&nbsp;
        <input class="userans" type="radio" name="q11" value="0"> 아니오<br><br>
        

        <label class="adoptionquestion" for="q12">반려동물을 입양하시려면, 입양비(구조 동물의 구조와 치료, 구제비로 사용)를 납부하셔야 하며 불임 수술 시행에도 동의하셔야 합니다. 동의하십니까?</label>
        <input class="userans" type="radio" name="q12" value="1"> 예&nbsp;
        <input class="userans" type="radio" name="q12" value="0"> 아니오<br><br>


        <label class="adoptionquestion" for="q13">그 외에 입양 신청에 관해 덧붙이고자 하시는 말씀이 있으시면 적어주시기 바랍니다.</label>
        <textarea class="userans" id="opinion" name="q13"></textarea><br><br>
